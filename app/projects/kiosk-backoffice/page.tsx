    ...
    <div className="p-6">
      <section className="max-w-6xl mx-auto space-y-10 py-10">
        ...
        <div className="space-y-8">
          <div>
            <h3 className="text-xl font-semibold text-slate-200">▶ {language === "Kor" ? "주요 기능과 문제 해결 흐름" : "Key Features & Problem-Solving Flow"}</h3>
          ...
          <div>
            <h3 className="text-xl font-semibold text-slate-200">▶ {language === "Kor" ? "배운 점" : "What I Learned"}</h3>
            <div className="space-y-5 mt-4">
              <ul className="list-disc pl-6 text-slate-300 whitespace-pre-line">
